...
int main() {
	...
	Coin_100 = (Blank1 - Coin_500 * 500) / 100;//100원 계산값
	Coin_50 = (Blank1 -(Coin_500 * 500 + Coin_100 * 100)) / 50;//50원 계산값
	Coin_10 = (Blank1 - (Coin_500 * 500 - Coin_100 * 100)) % 50;//10원 계산값

	printf("500원: %d개, 100원: %d개, 50원: %d개, 10원: %d개", Coin_500, Coin_100, Coin_50, Coin_10/10);
	return 0;
