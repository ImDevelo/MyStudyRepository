/*
  < Tic_tac_toe Game >..................( ver. 1.2.3 )

  [Patch Note]
  -이제 컴퓨터가 무작위로 돌을 놓습니다.( ver. 1.1.0)
  -이제 컴퓨터가 이길수 있는 상황과 질 수 있는 상황을 판별 합니다.( ver. 1.2.0 )
  -컴퓨터가 이길수 있거나 질 수 있는 상황에서 공격 혹은 방어를 할 수 있습니다. (ver 1.2.3 )
